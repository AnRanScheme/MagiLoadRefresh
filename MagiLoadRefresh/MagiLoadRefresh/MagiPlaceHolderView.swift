...
class MagiPlaceHolderView: MagiBasePlaceHolderView {
    ...
    override func setupSubviews() {
        ...
        if self.customView == nil {
            ...
            //按钮
            if let btnTitleString = btnTitleString,
                ...
                else if (btnClickClosure != nil) {
                    setupActionBtn(
                        btnTitle: btnTitleString,
                        target: nil,
                        action: nil,
                        btnClickBlock: btnClickClosure)
                }
...
extension MagiPlaceHolderView {
    ...
    //button
    func setupActionBtn(btnTitle: String,
                        target:AnyObject?,
                        action: Selector?,
